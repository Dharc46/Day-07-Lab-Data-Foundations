...
1. Các phương thức xin sự đồng ý của chủ thể dữ liệu cá nhân phải bảo đảm khả năng kiểm chứng được về việc xác định chủ thể dữ liệu cá nhân đã thực hiện sự đồng ý, thời điểm và nội dung được đồng ý, bao gồm:
   ...
   * đ) Bằng các phương thức khác phù hợp có thể in, sao chép bằng văn bản, bao gồm cả dưới dạng điện tử hoặc định dạng kiếm chứng được.
...
5. Các tổ chức, cá nhân áp dụng các biện pháp bảo vệ dữ liệu cá nhân trong hệ thống trí tuệ nhân tạo, vũ trụ ảo, gồm:
   * a) Nghiên cứu, xây dựng và triển khai hệ thống đáp ứng các tiêu chuẩn an ninh mạng, tiêu chuẩn bảo vệ dữ liệu toàn diện cho các hệ thống trí tuệ nhân tạo, đặc biệt chú trọng các yếu tố: bảo mật thông tin, độ tin cậy của thuật toán, tính ổn định hệ thống và khả năng phòng chống tấn công mạng;
...
6. Cơ quan chuyên trách bảo vệ dữ liệu cá nhân đánh giá, yêu cầu bên kiểm soát dữ liệu cá nhân, bên kiểm soát và xử lý dữ liệu cá nhân, bên xử lý dữ liệu cá nhân hoàn thiện Hồ sơ đánh giá tác động xử lý dữ liệu cá nhân trong thời hạn 30 ngày đối với trường hợp hồ sơ chưa đầy đủ and đúng quy định. Trường hợp bên kiểm soát dữ liệu cá nhân, bên kiểm soát và xử lý dữ liệu cá nhân, bên xử lý dữ liệu cá nhân không thực hiện hoàn thiện hồ sơ theo đúng quy định, cơ quan chuyên trách bảo vệ dữ liệu cá nhân xem xét áp dụng các quy định về xử phạt vi phạm hành chính trong lĩnh vực bảo vệ dữ liệu cá nhân.
...
Các dịch vụ xử lý dữ liệu cá nhân bao gồm:
...
8. Tổ chức kinh doanh dịch vụ xử lý dữ liệu cá nhân thực việc xác thực danh tính tổ chức theo quy định pháp luật về định danh và xác thực điện tử.
...
7. Đánh giá, sơ kết, tổng kết kết quả công tác bảo vệ dữ liệu cá nhân của cơ quan, tổ chức, cá nhân có liên quan.
...
1. Cơ quan chuyên trách bảo vệ dữ liệu cá nhân là đơn vị trực thuộc Bộ Công an, có trách nhiệm giúp Bộ trưởng Bộ Công an thực hiện chức năng quản lý nhà nước về bảo vệ dữ liệu cá nhân.
...
1. Doanh nghiệp nhỏ, doanh nghiệp khởi nghiệp được quyền lựa chọn thực hiện hoặc không thực hiện quy định tại Điều 21, Điều 22 và khoản 2 Điều 33 của Luật Bảo vệ dữ liệu cá nhân trong thời gian 05 năm kể từ ngày Luật Bảo vệ dữ liệu cá nhân có hiệu lực thi hành, trừ doanh nghiệp nhỏ, doanh nghiệp khởi nghiệp kinh doanh dịch vụ xử lý dữ liệu cá nhân, trực tiếp xử lý dữ liệu cá nhân nhạy cảm hoặc xử lý dữ liệu cá nhân kể từ thời điểm có quy mô đạt từ 100 nghìn chủ thể dữ liệu cá nhân trở lên dựa trên kết quả tích lũy tổng lượng dữ liệu cá nhân đã xử lý.
2. Hộ kinh doanh, doanh nghiệp siêu nhỏ không phải thực hiện quy định tại Điều 21, Điều 22 và khoản 2 Điều 33 của Luật Bảo vệ dữ liệu cá nhân, trừ hộ kinh doanh, doanh nghiệp siêu nhỏ kinh doanh dịch vụ xử lý dữ liệu cá nhân, trực tiếp xử lý dữ liệu cá nhân nhạy cảm hoặc xử lý dữ liệu cá nhân kể từ thời điểm có quy mô đạt từ 100 nghìn chủ thể dữ liệu cá nhân trở lên dựa trên kết quả tích lũy tổng lượng dữ liệu cá nhân đã xử lý.
...
## PHỤ LỤC: DANH MỤC HỒ SƠ VÀ BIỂU MẪU
...
| STT | Trường thông tin | Nội dung kê khai |
| :--- | :--- | :--- |
| **1** | Tên tổ chức/cá nhân (tiếng Việt): | |
| **1a** | Tên tổ chức/cá nhân (nước ngoài): | |
| **1b** | Tên tổ chức/cá nhân (viết tắt): | |
| **1c** | Mã số thuế: | |
| **2** | Địa chỉ (trụ sở chính): | |
| **3** | Điện thoại: | |
| **4** | Lĩnh vực kinh doanh có xử lý dữ liệu cá nhân (kèm theo mã ngành đăng ký kinh doanh tương ứng): | |
| **5** | Số lượng chi nhánh, văn phòng đại diện: | |
| **6** | Email: | |
| **7** | Website: | |
| **8** | Bộ phận/Nhân sự bảo vệ dữ liệu cá nhân của tổ chức, cá nhân: | |
| **8.1** | Tổ chức cung cấp dịch vụ bảo vệ dữ liệu cá nhân *(nếu có, kèm theo hợp đồng sử dụng dịch vụ)*:<br>- Tên tổ chức:<br>- Mã số thuế:<br>- Người đại diện theo pháp luật:<br>- Địa chỉ:<br>- Điện thoại:<br>- Email:<br>- Website: | |
| **8.2** | Cá nhân cung cấp dịch vụ bảo vệ dữ liệu cá nhân *(nếu có, kèm theo hợp đồng sử dụng dịch vụ)*:<br>*(TT - Họ và tên - Đơn vị công tác - Số điện thoại - Email)* | |
| **8.3** | Bộ phận/nhân sự bảo vệ dữ liệu cá nhân nội bộ của tổ chức *(kèm theo bản sao quyết định hoặc văn bản chỉ định và giấy tờ chứng minh đủ điều kiện theo Nghị định số 356/2025/NĐ-CP)*:<br>- Tên Bộ phận:<br>- Điện thoại Bộ phận:<br>- Email Bộ phận:<br>- Tên người đứng đầu Bộ phận / Tên nhân sự:<br>- Chức vụ:<br>- Điện thoại di động:<br>- Email cá nhân: | |

##### II. HOẠT ĐỘNG CHUYỂN DỮ LIỆU CÁ NHÂN XUYÊN BIÊN GIỚI

| STT | Trường thông tin | Nội dung kê khai |
| :--- | :--- | :--- |
| **1** | **Hình thức chuyển dữ liệu cá nhân xuyên biên giới:**<br>- 1.1. Chuyển giao dữ liệu cá nhân thu thập, lưu trữ tại Việt Nam đến hệ thống máy chủ đặt ngoài lãnh thổ nước Cộng hòa xã hội chủ nghĩa Việt Nam [ ]<br>- 1.2. Lưu trữ, xử lý dữ liệu cá nhân trên dịch vụ điện toán đám mây của nhà cung cấp dịch vụ ở nước ngoài [ ]<br>- 1.3. Thu thập dữ liệu cá nhân của cá nhân sử dụng dịch vụ tại Việt Nam và chuyển đến nền tảng ở ngoài lãnh thổ nước Cộng hòa xã hội chủ nghĩa Việt Nam để tiếp tục xử lý [ ]<br>- 1.4. Chuyển dữ liệu cá nhân xuyên biên giới thông qua đối tác, đại lý trung gian tại Việt Nam [ ]<br>- 1.5. Trường hợp khác (nêu cụ thể) [ ] | *(Kê khai chi tiết tên đối tượng chủ thể dữ liệu cá nhân, số lượng tương ứng với từng hình thức)* |
| **2** | **Luồng chuyển dữ liệu cá nhân xuyên biên giới:**<br>- Nêu rõ đối tượng chủ thể, mục đích chuyển, có chuyển dữ liệu cá nhân nhạy cảm hay không và hoạt động xử lý sau khi chuyển tương ứng.<br>- Mô hình hóa sơ đồ quy trình và hệ thống chuyển dữ liệu cá nhân xuyên biên giới. | |
| **3** | **Loại dữ liệu cá nhân được xử lý:** | - Tổng số loại dữ liệu cá nhân cơ bản:<br>- Tổng số loại dữ liệu cá nhân nhạy cảm: |
| **3.1** | **Dữ liệu cá nhân cơ bản** *(đánh dấu [x] vào loại dữ liệu cá nhân quy định)*:<br>[ ] Họ, chữ đệm và tên khai sinh<br>[ ] Tên gọi khác (nếu có)<br>[ ] Ngày, tháng, năm sinh<br>[ ] Ngày, tháng, năm chết hoặc mất tích<br>[ ] Giới tính<br>[ ] Nơi sinh<br>[ ] Nơi đăng ký khai sinh<br>[ ] Nơi đăng ký thường trú<br>[ ] Nơi đăng ký tạm trú<br>[ ] Nơi ở hiện tại<br>[ ] Quê quán<br>[ ] Địa chỉ liên hệ<br>[ ] Quốc tịch<br>[ ] Hình ảnh của cá nhân<br>[ ] Số điện thoại<br>[ ] Số định danh cá nhân<br>[ ] Số hộ chiếu<br>[ ] Số giấy phép lái xe<br>[ ] Số biển số xe<br>[ ] Tình trạng hôn nhân<br>[ ] Mối quan hệ gia đình (cha mẹ, con, vợ chồng)<br>[ ] Thông tin về tài khoản số của cá nhân<br>[ ] Các thông tin khác gắn liền với một con người cụ thể | |
| **3.2** | **Dữ liệu cá nhân nhạy cảm** *(đánh dấu [x] vào loại dữ liệu cá nhân quy định)*:<br>[ ] Dữ liệu tiết lộ nguồn gốc chủng tộc, dân tộc<br>[ ] Quan điểm chính trị<br>[ ] Quan điểm tôn giáo, tín ngưỡng<br>[ ] Đời sống riêng tư, bí mật cá nhân, bí mật gia đình<br>[ ] Tình trạng sức khỏe<br>[ ] Dữ liệu sinh trắc học, đặc điểm di truyền<br>[ ] Tiết lộ đời sống tình dục, xu hướng tình dục<br>[ ] Dữ liệu về tội phạm, vi phạm pháp luật từ cơ quan thực thi pháp luật<br>[ ] Vị trí cá nhân qua dịch vụ định vị<br>[ ] Tên đăng nhập, mật khẩu tài khoản định danh điện tử<br>[ ] Hình ảnh thẻ căn cước, CCCD, CMND<br>[ ] Tên đăng nhập, mật khẩu truy cập tài khoản ngân hàng<br>[ ] Thông tin thẻ ngân hàng, lịch sử giao dịch ngân hàng<br>[ ] Thông tin tài chính, tín dụng, giao dịch chứng khoán, bảo hiểm...<br>[ ] Dữ liệu theo dõi hành vi sử dụng dịch vụ viễn thông, MXH, internet...<br>[ ] Dữ liệu cá nhân khác cần giữ bí mật đặc biệt | |
| **4** | **Nội dung quy định về việc lưu trữ dữ liệu cá nhân** *(kèm theo văn bản chính sách lưu trữ)* | |
| **5** | **Nội dung quy định về việc xóa, hủy dữ liệu cá nhân** *(kèm theo văn bản chính sách xóa, hủy)* | |
| **6** | **Chuyển giao dữ liệu cá nhân** *(theo Điều 17 Luật BVĐLCN)*:<br>- Có [ ] / Không [ ]<br>- Chuyển giao dữ liệu cá nhân có thu phí:<br>- Có [ ] / Không [ ] | |
| **7** | **Tham gia hoạt động giao dịch trên sàn dữ liệu:**<br>- Có [ ] / Không [ ] | |
| **8** | **Kinh doanh dịch vụ xử lý dữ liệu cá nhân:**<br>- Có [ ] / Không [ ]<br>- Danh mục dịch vụ cung cấp:<br>[ ] Vận hành phần mềm tự động thay mặt bên kiểm soát<br>[ ] Chấm điểm, xếp hạng, đánh giá tín nhiệm<br>[ ] Thu thập, xử lý trực tuyến từ web, ứng dụng, MXH<br>[ ] Thu thập, xử lý dữ liệu sức khỏe, y tế<br>[ ] Thu thập, xử lý dữ liệu qua app giáo dục có giám sát<br>[ ] Phân tích và khai thác dữ liệu cá nhân<br>[ ] Mã hóa dữ liệu truyền tải và lưu trữ<br>[ ] Xử lý tự động qua Big Data, AI, Blockchain, Metaverse<br>[ ] Nền tảng cung cấp dữ liệu vị trí | |
| **9** | **Biện pháp bảo vệ dữ liệu cá nhân:** | |
| **9.1** | Phương án bảo đảm an toàn dữ liệu cá nhân *(nêu rõ các phương án đang triển khai)* | |
| **9.2** | Biện pháp bảo vệ dữ liệu cá nhân *(biện pháp kỹ thuật, quản lý, đào tạo; tiêu chuẩn áp dụng; sơ đồ thiết kế hệ thống)* | |
| **9.3** | Kiểm tra, đánh giá an ninh mạng, an toàn hệ thống thông tin, thiết bị *(nêu cụ thể nội dung, đối tượng, tần suất)* | |
| **9.4** | Phương án bảo đảm an toàn dữ liệu cá nhân của Bên nhận dữ liệu cá nhân xuyên biên giới | |
| **10** | **Đánh giá tuân thủ các quy định về bảo vệ dữ liệu cá nhân** *(hình thức, thời điểm, kết quả đánh giá)* | |

##### III. ĐÁNH GIÁ TÁC ĐỘNG CHUYỂN DỮ LIỆU CÁ NHÂN XUYÊN BIÊN GIỚI

1. **Đánh giá tổng quan tình hình, hoạt động kinh doanh có liên quan tới việc chuyển dữ liệu cá nhân xuyên biên giới:**
   * Nêu rõ sự cần thiết của hoạt động chuyển dữ liệu cá nhân xuyên biên giới trong lĩnh vực hoạt động của tổ chức;
   * Thực trạng xử lý dữ liệu cá nhân của tổ chức bao gồm thuận lợi và khó khăn, rủi ro trong việc chuyển dữ liệu cá nhân xuyên biên giới.
2. **Đánh giá tác động việc chuyển dữ liệu cá nhân xuyên biên giới:**
   * Đánh giá theo từng nội dung cụ thể, phân tích mỗi vấn đề bao gồm mô tả thực trạng, phân tích yêu cầu, dự kiến tình huống phát sinh, nguyên nhân, giải pháp;
   * Đánh giá tác động các giải pháp đề xuất (tích cực, tiêu cực) của từng giải pháp; kiến nghị trên cơ sở so sánh tác động. Tác động được đánh giá theo phương pháp định lượng, định tính, nêu rõ hậu quả, thiệt hại không mong muốn có khả năng xảy ra, các biện pháp giảm thiểu hoặc loại bỏ nguy cơ, tác hại đó.
   * **2.1. Tác động đến chủ thể dữ liệu:** Phân tích khả năng tác động trực tiếp của việc xử lý dữ liệu cá nhân tới các quyền và lợi ích của chủ thể dữ liệu.
     ...
     4. Đánh giá hiệu quả và tác động của các biện pháp đối với đối tượng chịu sự tác động trực tiếp và các đối tượng liên quan
     5. Kiến nghị biện pháp bảo vệ dữ liệu cá nhân lựa chọn
   * **2.2. Tác động đến an ninh, an toàn thông tin hệ thống của tổ chức:** Đánh giá mức độ bảo mật, toàn vẹn và khả năng sẵn sàng của hệ thống thông tin. Tập trung vào nguy cơ lộ lọt, truy cập trái phép, thay đổi trái phép dữ liệu, gián đoạn vận hành hệ thống, mức độ đáp ứng của các biện pháp kỹ thuật hiện hữu và khả năng phát sinh lỗ hổng bảo mật.
     1. Xác định các khía cạnh tác động và vấn đề
     2. Mục tiêu giải quyết vấn đề
     3. Các biện pháp bảo vệ dữ liệu cá nhân đã áp dụng và đề xuất để giải quyết vấn đề
     4. Đánh giá hiệu quả và tác động của các biện pháp đối với đối tượng chịu tác động trực tiếp và liên quan
     5. Kiến nghị biện pháp bảo vệ dữ liệu cá nhân lựa chọn
   * **2.3. Tác động đến an ninh quốc gia, trật tự an toàn xã hội:** Đánh giá trong trường hợp xử lý và chuyển dữ liệu cá nhân cơ bản của trên 100.000 chủ thể dữ liệu hoặc dữ liệu cá nhân nhạy cảm của trên 10.000 chủ thể dữ liệu. Tập trung vào ảnh hưởng của việc chuyển số lượng lớn dữ liệu cá nhân ra nước ngoài đối với an ninh quốc gia, trật tự an toàn xã hội và biện pháp bảo vệ tương ứng.
     1. Xác định các khía cạnh tác động và vấn đề
     2. Mục tiêu giải quyết vấn đề
     3. Các biện pháp bảo vệ dữ liệu cá nhân đã áp dụng và đề xuất để giải quyết vấn đề
     4. Đánh giá hiệu quả và tác động của các biện pháp đối với đối tượng chịu tác động trực tiếp và liên quan
     5. Kiến nghị biện pháp bảo vệ dữ liệu cá nhân lựa chọn
3. **Đánh giá mức độ bảo vệ dữ liệu cá nhân của Bên nhận dữ liệu cá nhân:**
   * 3.1. Cách thức xử lý và lưu trữ dữ liệu của Bên nhận dữ liệu cá nhân *(nêu rõ với từng luồng)*
   * 3.2. Phương án bảo đảm an toàn dữ liệu cá nhân của Bên nhận dữ liệu cá nhân *(các phương án đang triển khai)*
   * 3.3. Các biện pháp bảo vệ dữ liệu cá nhân của Bên nhận dữ liệu cá nhân *(biện pháp kỹ thuật, quản lý, đào tạo; tiêu chuẩn áp dụng)*
   * 3.4. Đánh giá cách thức xử lý và lưu trữ, phương án bảo đảm và các biện pháp bảo vệ dữ liệu cá nhân của Bên nhận dữ liệu cá nhân *(mức độ đầy đủ, hiệu quả; đáp ứng pháp luật Việt Nam; khả năng phòng ngừa rủi ro; nhận định rủi ro tồn tại và đề xuất biện pháp bổ sung)*
4. **Phụ lục:** *(Liệt kê danh sách tên các tài liệu, chính sách, quy trình, quy định, biểu mẫu kèm theo hồ sơ)*

##### PHẦN B. THÔNG TIN CÁC BÊN LIÊN QUAN TRONG HOẠT ĐỘNG CHUYỂN DỮ LIỆU CÁ NHÂN XUYÊN BIÊN GIỚI

**I. THÔNG TIN CỦA BÊN THAY MẶT BÊN CHUYỂN THỰC HIỆN CHUYỂN DỮ LIỆU CÁ NHÂN XUYÊN BIÊN GIỚI**
*(Kê khai trong trường hợp thỏa thuận cho bên khác trực tiếp chuyển dữ liệu cá nhân xuyên biên giới)*

| STT | Tên tổ chức/cá nhân | Mã số thuế | Thông tin Bộ phận/ Nhân sự bảo vệ dữ liệu cá nhân | Hợp đồng/ Thỏa thuận chuyển dữ liệu xuyên biên giới (Số, ngày) | Dịch vụ hợp tác | Ghi chú (Lý do, giải thích) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| | | | | | | |

**II. THÔNG TIN CỦA BÊN NHẬN DỮ LIỆU CÁ NHÂN XUYÊN BIÊN GIỚI**
*(Kê khai phù hợp với mối quan hệ trong hoạt động chuyển và nhận dữ liệu cá nhân)*

| STT | Tên tổ chức/cá nhân | Mã số thuế | Thông tin Bộ phận/ Nhân sự bảo vệ dữ liệu cá nhân | Hợp đồng/ Thỏa thuận chuyển dữ liệu xuyên biên giới (Số, ngày) | Dịch vụ hợp tác | Ghi chú (Lý do, giải thích) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| | | | | | | |

**III. THÔNG TIN CỦA BÊN KHÁC**
*(Các bên khác có liên quan trong hoạt động chuyển dữ liệu cá nhân xuyên biên giới)*

| STT | Tên tổ chức/cá nhân | Mã số thuế | Thông tin Bộ phận/ Nhân sự bảo vệ dữ liệu cá nhân | Hợp đồng/ Thỏa thuận có liên quan (Số, ngày) | Dịch vụ hợp tác | Ghi chú (Lý do, giải thích) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| | | | | | | |
...
| **8.1** | Tổ chức cung cấp dịch vụ bảo vệ dữ liệu cá nhân *(nếu có, kèm theo hợp đồng sử dụng dịch vụ)*:<br>- Tên tổ chức:<br>- Mã số thuế:<br>- Người đại diện theo pháp luật:<br>- Địa chỉ:<br>- Điện thoại:<br>- Email:<br>- Website: | |
| **8.2** | Cá nhân cung cấp dịch vụ bảo vệ dữ liệu cá nhân *(nếu có, kèm theo hợp đồng sử dụng dịch vụ)*:<br>*(TT - Họ và tên - Đơn vị công tác - Số điện thoại - Email)* | |
| **8.3** | Bộ phận/nhân sự bảo vệ dữ liệu cá nhân nội bộ của tổ chức *(kèm theo bản sao quyết định hoặc văn bản thể hiện việc chỉ định, phân công)*:<br>- Tên Bộ phận:<br>- Điện thoại Bộ phận:<br>- Email Bộ phận:<br>- Tên người đứng đầu Bộ phận / Tên nhân sự:<br>- Chức vụ:<br>- Điện thoại di động:<br>- Email cá nhân: | |

##### II. HOẠT ĐỘNG XỬ LÝ DỮ LIỆU CÁ NHÂN

| STT | Trường thông tin | Nội dung kê khai |
| :--- | :--- | :--- |
| **1** | **Xác định vai trò xử lý dữ liệu cá nhân của bên kê khai:**<br>- 1.1. Bên kiểm soát dữ liệu cá nhân, Bên kiểm soát và xử lý dữ liệu cá nhân [ ]<br>- 1.2. Bên xử lý dữ liệu cá nhân [ ]<br>- 1.3. Bên thứ ba [ ] | *(Kê khai rõ các loại đối tượng chủ thể như khách hàng, người lao động, ứng viên... kèm theo số lượng tính đến thời điểm nộp hồ sơ tương ứng với vai trò)* |
| **2** | **Luồng xử lý dữ liệu cá nhân theo vai trò:**<br>- Nêu rõ đối tượng chủ thể, mục đích xử lý, loại dữ liệu cá nhân cơ bản/ nhạy cảm được xử lý và hoạt động xử lý tương ứng.<br>- Mô hình hóa sơ đồ quy trình và hệ thống xử lý dữ liệu cá nhân tương ứng với từng vai trò. | |
| **3** | **Loại dữ liệu cá nhân được xử lý:** | - Tổng số loại dữ liệu cá nhân cơ bản:<br>- Tổng số loại dữ liệu cá nhân nhạy cảm: |
| **3.1** | **Dữ liệu cá nhân cơ bản** *(đánh dấu [x] vào loại dữ liệu cá nhân quy định)*:<br>[ ] Họ, chữ đệm và tên khai sinh<br>[ ] Tên gọi khác (nếu có)<br>[ ] Ngày, tháng, năm sinh<br>[ ] Ngày, tháng, năm chết hoặc mất tích<br>[ ] Giới tính<br>[ ] Nơi sinh<br>[ ] Nơi đăng ký khai sinh<br>[ ] Nơi đăng ký thường trú<br>[ ] Nơi đăng ký tạm trú<br>[ ] Nơi ở hiện tại<br>[ ] Quê quán<br>[ ] Địa chỉ liên hệ<br>[ ] Quốc tịch<br>[ ] Hình ảnh của cá nhân<br>[ ] Số điện thoại<br>[ ] Số định danh cá nhân<br>[ ] Số hộ chiếu<br>[ ] Số giấy phép lái xe<br>[ ] Số biển số xe<br>[ ] Tình trạng hôn nhân<br>[ ] Mối quan hệ gia đình (cha mẹ, con, vợ chồng)<br>[ ] Thông tin về tài khoản số của cá nhân<br>[ ] Các thông tin khác gắn liền với một con người cụ thể | |
| **3.2** | **Dữ liệu cá nhân nhạy cảm** *(đánh dấu [x] vào loại dữ liệu cá nhân quy định)*:<br>[ ] Dữ liệu tiết lộ nguồn gốc chủng tộc, dân tộc<br>[ ] Quan điểm chính trị<br>[ ] Quan điểm tôn giáo, tín ngưỡng<br>[ ] Đời sống riêng tư, bí mật cá nhân, bí mật gia đình<br>[ ] Tình trạng sức khỏe<br>[ ] Dữ liệu sinh trắc học, đặc điểm di truyền<br>[ ] Tiết lộ đời sống tình dục, xu hướng tình dục<br>[ ] Dữ liệu về tội phạm, vi phạm pháp luật từ cơ quan thực thi pháp luật<br>[ ] Vị trí cá nhân qua dịch vụ định vị<br>[ ] Tên đăng nhập, mật khẩu tài khoản định danh điện tử<br>[ ] Hình ảnh thẻ căn cước, CCCD, CMND<br>[ ] Tên đăng nhập, mật khẩu truy cập tài khoản ngân hàng<br>[ ] Thông tin thẻ ngân hàng, lịch sử giao dịch ngân hàng<br>[ ] Thông tin tài chính, tín dụng, giao dịch chứng khoán, bảo hiểm...<br>[ ] Dữ liệu theo dõi hành vi sử dụng dịch vụ viễn thông, MXH, internet...<br>[ ] Dữ liệu cá nhân khác cần giữ bí mật đặc biệt | |
| **4** | **Sự đồng ý của chủ thể dữ liệu cá nhân** *(mô tả cụ thể nội dung, hình thức, quy trình xin sự đồng ý của từng đối tượng và kèm biểu mẫu)* | |
| **5** | **Nội dung quy định về việc lưu trữ dữ liệu cá nhân** *(kèm theo văn bản chính sách lưu trữ)* | |
| **6** | **Nội dung quy định về việc xóa, hủy dữ liệu cá nhân** *(kèm theo văn bản chính sách xóa, hủy)* | |
| **7** | **Chuyển giao dữ liệu cá nhân** *(theo Điều 17 Luật BVĐLCN)*:<br>- Có [ ] / Không [ ]<br>- Chuyển giao dữ liệu cá nhân có thu phí:<br>- Có [ ] / Không [ ] | |
| **8** | **Tham gia hoạt động giao dịch trên sàn dữ liệu:**<br>- Có [ ] / Không [ ] | |
| **9** | **Kinh doanh dịch vụ xử lý dữ liệu cá nhân:**<br>- Có [ ] / Không [ ]<br>- Danh mục dịch vụ cung cấp:<br>[ ] Vận hành phần mềm tự động thay mặt bên kiểm soát<br>[ ] Chấm điểm, xếp hạng, đánh giá tín nhiệm<br>[ ] Thu thập, xử lý trực tuyến từ web, ứng dụng, MXH<br>[ ] Thu thập, xử lý dữ liệu sức khỏe, y tế<br>[ ] Thu thập, xử lý dữ liệu qua app giáo dục có giám sát<br>[ ] Phân tích và khai thác dữ liệu cá nhân<br>[ ] Mã hóa dữ liệu truyền tải và lưu trữ<br>[ ] Xử lý tự động qua Big Data, AI, Blockchain, Metaverse<br>[ ] Nền tảng cung cấp dữ liệu vị trí | |
| **10** | **Chuyển dữ liệu cá nhân xuyên biên giới:**<br>- Có [ ] / Không [ ] | |
| **11** | **Biện pháp bảo vệ dữ liệu cá nhân:** | |
| **11.1** | Phương án bảo đảm an toàn dữ liệu cá nhân *(nêu rõ các phương án đang triển khai)* | |
| **11.2** | Biện pháp bảo vệ dữ liệu cá nhân *(biện pháp kỹ thuật, quản lý, đào tạo; tiêu chuẩn áp dụng; sơ đồ thiết kế hệ thống)* | |
| **11.3** | Kiểm tra, đánh giá an ninh mạng, an toàn hệ thống thông tin, thiết bị *(nêu cụ thể nội dung, đối tượng, tần suất)* | |
| **12** | **Đánh giá tuân thủ các quy định về bảo vệ dữ liệu cá nhân** *(hình thức, thời điểm, kết quả đánh giá)* | |

##### III. ĐÁNH GIÁ TÁC ĐỘNG XỬ LÝ DỮ LIỆU CÁ NHÂN

1. **Đánh giá tổng quan tình hình, hoạt động kinh doanh có liên quan tới việc thu thập, xử lý dữ liệu cá nhân:**
   * Nêu rõ sự cần thiết của hoạt động xử lý dữ liệu cá nhân trong lĩnh vực hoạt động của tổ chức;
   * Thực trạng xử lý dữ liệu cá nhân của tổ chức bao gồm thuận lợi và khó khăn, rủi ro trong việc xử lý dữ liệu cá nhân.
2. **Đánh giá tác động việc xử lý dữ liệu cá nhân:**
   ...
   * **2.1. Tác động đến chủ thể dữ liệu:** Phân tích khả năng tác động trực tiếp của việc xử lý dữ liệu cá nhân tới các quyền và lợi ích của chủ thể dữ liệu.
     ...
     2. Mục tiêu giải quyết vấn đề
     3. Các biện pháp bảo vệ dữ liệu cá nhân đã áp dụng và đề xuất để giải quyết vấn đề
     4. Đánh giá hiệu quả và tác động của các biện pháp đối với đối tượng chịu tác động trực tiếp và các đối tượng liên quan
     5. Kiến nghị biện pháp bảo vệ dữ liệu cá nhân lựa chọn
   * **2.2. Tác động đến an ninh, an toàn thông tin hệ thống của tổ chức:** Đánh giá mức độ bảo mật, toàn vẹn và khả năng sẵn sàng của hệ thống thông tin. Tập trung vào nguy cơ lộ lọt, truy cập trái phép, thay đổi trái phép dữ liệu, gián đoạn vận hành hệ thống, mức độ đáp ứng của các biện pháp kỹ thuật hiện hữu và khả năng phát sinh lỗ hổng bảo mật.
     1. Xác định các khía cạnh tác động và vấn đề
     2. Mục tiêu giải quyết vấn đề
     ...
     4. Đánh giá hiệu quả và tác động của các biện pháp đối với đối tượng chịu tác động trực tiếp và liên quan
     5. Kiến nghị biện pháp bảo vệ dữ liệu cá nhân lựa chọn
   * **2.3. Tác động đến an ninh quốc gia, trật tự an toàn xã hội:** Đánh giá trong trường hợp xử lý dữ liệu cá nhân cơ bản của trên 100.000 chủ thể dữ liệu hoặc dữ liệu cá nhân nhạy cảm của trên 10.000 chủ thể dữ liệu. Tập trung vào ảnh hưởng của việc xử lý dữ liệu cá nhân với số lượng lớn có thể gây ảnh hưởng đến an ninh quốc gia, trật tự an toàn xã hội và các biện pháp bảo vệ dữ liệu cá nhân tương ứng.
     1. Xác định các khía cạnh tác động và vấn đề
     2. Mục tiêu giải quyết vấn đề
     3. Các biện pháp bảo vệ dữ liệu cá nhân đã áp dụng và đề xuất để giải quyết vấn đề
     4. Đánh giá hiệu quả và tác động của các biện pháp đối với đối tượng chịu tác động trực tiếp và liên quan
     5. Kiến nghị biện pháp bảo vệ dữ liệu cá nhân lựa chọn
3. **Phụ lục:** *(Liệt kê danh sách tên các tài liệu, chính sách, quy trình, quy định, biểu mẫu kèm theo hồ sơ)*

##### PHẦN B. THÔNG TIN CÁC BÊN LIÊN QUAN TRONG HOẠT ĐỘNG XỬ LÝ DỮ LIỆU CÁ NHÂN

**I. THÔNG TIN CỦA BÊN KIỂM SOÁT DỮ LIỆU CÁ NHÂN**
*(Kê khai phù hợp với mối quan hệ trong hoạt động xử lý dữ liệu cá nhân)*

| STT | Tên tổ chức/cá nhân | Mã số thuế | Thông tin Bộ phận/ Nhân sự bảo vệ dữ liệu cá nhân | Hợp đồng/ Thỏa thuận xử lý dữ liệu cá nhân (Số, ngày) | Dịch vụ hợp tác | Ghi chú (Lý do, giải thích) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| | | | | | | |
...
**III. THÔNG TIN CỦA BÊN THỰC THI/BÊN THỨ BA**
*(Kê khai phù hợp với mối quan hệ trong hoạt động xử lý dữ liệu cá nhân)*
